 ...
 * @author Ramonella
 */
public class Resta extends elementoOperacion{
    public Generador gen;
    
    public Resta(Generador c){
        this.gen= c;
    }
    ...
    public Valor operar(Valor v1, Valor v2){
        ...
        erroresEjecucion.addSemantico(0, 0, "Tipo no valido para realizar una resta, "+ v1.tipo+" y "+ v2.tipo);
        return new Valor();
    }
